package org.voltas.storm.sentimentanalytics.spouts;
 ...
 *
 */
public final class TwitterStreamSpout extends BaseRichSpout {
	...
	public final void open(final Map conf, final TopologyContext context,
		...
		try {
			properties.load(TwitterStreamSpout.class.getClassLoader()
