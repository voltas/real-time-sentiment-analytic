package org.voltas.storm.sentimentanalytics.bolts;
...
import org.voltas.storm.sentimentanalytics.utils.*;
 ...
 *
 */
public final class CalculateSentimentBolt extends BaseRichBolt {
	private static final Logger LOGGER = LoggerFactory.getLogger(CalculateSentimentBolt.class);
